...
from quarry.auth import PlayerPublicKey
from quarry.crypto import verify_mojang_v1_signature, verify_mojang_v2_signature
from quarry.protocol import Factory, Protocol, ProtocolError, protocol_modes
from quarry import auth, crypto
from quarry.uuid import UUID
...
class ServerProtocol(Protocol):
    ...
    def packet_handshake(self, buff):
        ...
        self.protocol_version = data["protocolVersion":
